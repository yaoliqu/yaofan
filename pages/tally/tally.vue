<template>
	<view>
		...
		<view class="access"  >
			<access v-show="tabIndex==0"></access>
			<detail v-show="tabIndex==2"></detail>
			<total v-show="tabIndex==1"></total>
		</view>
	</view>
</template>

<script>
	import access from '@/pages/tally/access/access'
	import total from '@/pages/tally/total/total'
	import detail from '@/pages/tally/detail/detail'
	export default {
		data() {
			return {
				//吸顶导航
